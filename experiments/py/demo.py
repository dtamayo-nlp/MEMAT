...
def demo_model_editing(
    ...
    if torch.cuda.is_available():
        ...
        print("Using cpu, torch.cude.is_available() returns False")
    ...
    pre_update_text = generate_mine(model, tok, generation_prompts, pipeline_base)
    ...
    pipeline_after = load_pipeline(model_new, tok, device)
    post_update_text = generate_mine(
        model_new, tok, generation_prompts, pipeline_after
    )
