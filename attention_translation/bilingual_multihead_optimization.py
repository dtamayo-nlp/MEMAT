...
def heads_optimization(
    ...
    if language == "catalan":
        ...
        context_templates = get_context_templates(model, tok, "catalan", device)[:3] + get_context_templates(model, tok, "english", device)[:3]
    ...
    def edit_output_fn(cur_out, cur_layer):
        ...
        # cur_out has lenght (# batch, # toks, # heads, dim_head)
        # Note that we are analysing the head of the last token. This have its reasons also.
